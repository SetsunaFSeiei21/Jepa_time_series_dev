...
class DSTAGNN(BaseModel):
    ...
    def __init__(
        ...
        **args
        ...
        self.final_conv = nn.Conv2d(
            int((self.his_len / time_stride) * nb_block),
            128,
            kernel_size=(1, nb_time_filter),
        )
        self.final_fc = nn.Linear(128, self.pred_len)
    ...
    def forward(self, input_seq, input_features, *args, **kwargs):
        ...
        #     dim=-1,
        # )
        x = input_seq.permute(0, 2, 3, 1)  # (b, n, f, t)
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask, res_att):
        ...
        return (
            nn.LayerNorm(self.d_model).to(input_Q.device)(output + residual),
            res_attn,
        )
